        ...
        public IList<TextLocation> GetLocations()
        {
            ...
            foreach (var chunk in filteredTextChunks)
            {
                ...
                if (lastChunk == null)
                {
                    ...
                    {
                        Text = chunk.Text,
                        XS = chunk.Location.StartLocation[0],
                        YS = chunk.Location.StartLocation[1],
                        XE = chunk.Location.EndLocation[0],
                        YE = chunk.Location.EndLocation[1]
                    });
